# Contributing Guidelines for macutil
...
2. Clone the fork
```bash
git clone https://github.com/YOUR_USERNAME_HERE/macutil.git
cd macutil
   ```
...
- **Agree to the license**: By contributing to macutil, you agree that your contributions will be licensed under the project's MIT license.

We appreciate your contributions and look forward to collaborating with you to make macutil better!
